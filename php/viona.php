...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="logout.html" tabindex="-1" aria-disabled="true"> <i class="bi bi-door-open"></i>logout</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-5 col-lg-4">
                    <img src="../image/product/chilled-meat.jpg" class="img-fluid" alt="">
                </div>
                <!-- Produk detail -->
                <div class="col-md-6 offset-md-1 col-lg-7 offset-lg-1">
                    <h1>Viona Catering</h1>
                    <p>Viona Catering adalah catering yang Menyediakan menu-menu yang beragam mulai dari menu untuk acara kumpul dengan saudara, arisan maupun acara kantor</p>
                    <h2>Menu</h2>
                    ...
                    <p><b>Peket 4: </b>Maksimal order 300 porsi 
                    </p>
                    <p>Untuk pemesanan catering, silakan membayar melalui transfer bank di bawah:</p>
                    <p>No rek: 0928897383 atas nama Viona Catering<br>
    ...
    <div class="container py-5">
        ...
        <div class="map-container">
            <iframe 
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12692.889097722424!2d104.71997!3d-3.0135104!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e3b9fe82ff16d8f%3A0x14d78c34dc810d55!2sViona%20catering!5e0!3m2!1sen!2sid!4v1681234567890!5m2!1sen!2sid"
                frameborder="0" 
                style="border:0;" 
                allowfullscreen="" 
                aria-hidden="false" 
